...
export function ReelsViewer({ onProfileClick }: { onProfileClick: (u: string) => void }) {
  const [reels, setReels] = useState([
    ...
    { id: "3", user: "NeonPulse", description: "Night vibes in the bio-dome. 🌱⚡", likes: 256, comments: 42, video: "https://picsum.photos/seed/reel3/1080/1920", liked: false, following: false },
  ]);
            ...
            <div className="absolute bottom-12 left-8 right-20 space-y-5">
              <div className="flex items-center gap-4">
                ...
                <button 
                  ...
                  className={cn(
                    "ml-2 px-5 py-2 text-[10px] font-black rounded-xl uppercase tracking-widest transition-all",
              ...
              <p className="text-sm text-white/90 leading-relaxed font-medium max-w-[90%]">{reel.description}</p>
