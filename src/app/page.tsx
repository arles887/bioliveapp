  ...
  return (
    <main className="fixed inset-0 flex items-center justify-center bg-black overflow-hidden font-body">
      ...
      <div className="relative w-full h-full max-w-[420px] bg-[#020503] flex flex-col shadow-2xl border-x border-white/5 overflow-hidden ring-1 ring-white/10">
        ...
        <div className="flex-1 overflow-y-auto relative z-10 no-scrollbar pb-32">
          ...
          {activeTab === "profile" && (
             <div className="flex flex-col items-center justify-center min-h-[80vh] p-8 text-center space-y-8 animate-in fade-in duration-500">
               <div className="relative w-28 h-28 rounded-[2rem] bg-primary/10 border border-primary/30 flex items-center justify-center overflow-hidden">
               ...
               <div className="space-y-2">
                ...
                <p className="text-[10px] text-white/40 uppercase tracking-widest">Protocolo Desconectado</p>
               </div>
          ...
          {activeTab === "upload" && (
            <div className="flex flex-col items-center justify-center min-h-[80vh] p-8 text-center space-y-8">
               ...
               <div className="grid grid-cols-1 gap-4 w-full">
                  <div className="p-10 glass-panel rounded-[2rem] flex flex-col items-center justify-center gap-4 cursor-pointer hover:border-primary/40 transition-all">
                    <div className="w-12 h-12 bg-primary rounded-2xl flex items-center justify-center text-black shadow-lg"><span className="font-black italic">LIVE</span></div>
                    <span className="text-[10px] font-black uppercase tracking-widest text-primary italic">Iniciar Nodo Neuronal</span>
                  </div>
                  <div className="p-8 glass-panel border-dashed border-white/10 rounded-[2rem] flex flex-col items-center justify-center gap-4 cursor-pointer">
        ...
        {/* Modales - Deben estar al final para z-index máximo */}
